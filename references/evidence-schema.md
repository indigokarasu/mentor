...
| File | Path |
|------|------|
| Evidence log | `<hermes-root>/commons/data/mentor/evidence.jsonl` |
| Ingestion log | `<hermes-root>/commons/data/mentor/ingestion_log.jsonl` |
| Anomalies | `<hermes-root>/commons/data/mentor/anomalies.jsonl` |
| Decisions | `<hermes-root>/commons/data/mentor/decisions.jsonl` |
| OKR state | `<hermes-root>/commons/data/mentor/okr_state.json` |
| Journals | `<hermes-home>/commons/journals/ocas-mentor/YYYY-MM-DD/` |

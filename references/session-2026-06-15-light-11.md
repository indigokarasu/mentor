...
- `<hermes-root>/commons/data/mentor/evidence.jsonl` (+1 line: caller backup)
- `<hermes-root>/commons/data/mentor/ingestion_log.jsonl` (+10 lines: caller backup)
- `<hermes-home>/commons/journals/ocas-mentor/2026-06-15/mentor-light-20260615T201552Z.json` (script journal)
- `<hermes-home>/commons/journals/ocas-mentor/2026-06-15/mentor-light-caller-20260615T202035Z.json` (caller journal, synced to commons)

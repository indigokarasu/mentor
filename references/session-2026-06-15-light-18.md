...
- `<hermes-home>/profiles/indigo/commons/data/mentor/ingestion_log.jsonl` (+12 lines)
- `<hermes-home>/profiles/indigo/commons/journals/ocas-mentor/2026-06-15/mentor-light-20260615T225357Z.json` (new)
- `<hermes-home>/commons/data/mentor/ingestion_log.jsonl` (+12 lines synced)
=======
- `~/.hermes/profiles/indigo/commons/data/mentor/evidence.jsonl` (+2 lines: script + backup)
- `~/.hermes/profiles/indigo/commons/data/mentor/ingestion_log.jsonl` (+12 lines)
- `~/.hermes/profiles/indigo/commons/journals/ocas-mentor/2026-06-15/mentor-light-20260615T225357Z.json` (new)
- `~/.hermes/commons/data/mentor/ingestion_log.jsonl` (+12 lines synced)
>>>>>>> Stashed changes

...
- **Taste**: Token repair required — both owner and indigo accounts had Mode 1 (timezone suffix `+00:00`). After repair, scan succeeded: 1 signal created (Lavash/DoorDash).
- **Email**: 5 owner + 5 indigo emails. All informational (priority 30), 0 high-priority. No escalation needed.

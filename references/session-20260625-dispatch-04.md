...
1. **Email (8 threads):** All `action:none`. owner: 1 thread (Google ToS notice, informational). Indigo: 7 threads (1 personal already-replied, 1 dev_notification, 1 self-sent, 4 informational). Inline optimization applied — no delegation needed.

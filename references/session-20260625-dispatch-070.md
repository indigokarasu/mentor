...
```bash
echo '{"journal_id":"ocas-praxis/2026-06-25/praxis-dispatch-20260625T044806Z.json","evaluated_at":"ISO_NOW","action_taken":"dispatch_output_skip"}' >> <hermes-home>/commons/data/ocas-praxis/journals_evaluated.jsonl
```

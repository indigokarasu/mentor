...
- Email triage was all "no action" — the dispatcher's `actionable` count was misleading (7 for indigo, 1 for owner) because it counts unread threads, not genuinely actionable ones.

...
JOURNALS_PATHS = ["<hermes-root>/commons/journals/", "<hermes-home>/commons/journals/"]
MENTOR_DATA = "<hermes-root>/commons/data/mentor/"
PROFILE_MENTOR_DATA = "<hermes-home>/commons/data/mentor/"
...
def main():
    ...
    jdir = os.path.join("<hermes-home>/commons/journals/ocas-mentor", today_str)
